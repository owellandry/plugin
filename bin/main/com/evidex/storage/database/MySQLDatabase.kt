...
class MySQLDatabase(config: ConfigManager) : PooledDatabase(config) {

    override fun connect() {
        createDataSource(
            jdbcUrl = "jdbc:mysql://${config.getDatabaseHost()}:${config.getDatabasePort()}/${config.getDatabaseName()}${config.getDatabaseParams()}",
